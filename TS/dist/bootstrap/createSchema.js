...
const createGraphqlSchema = async () => {
    return (0, type_graphql_1.buildSchema)({
        resolvers: [userResolver_1.UserResolver, movieResolver_1.MovieResolver, rapResolver_1.RapResolver, likeResolver_1.LikeResolver, commentResolver_1.CommentResolver, movieRapResolver_1.MovieRapResolver],
    });
};
